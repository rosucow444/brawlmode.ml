...
/*
function ul(o){var e=o,n=window.location.protocol+"//"+window.location.hostname,t=new RegExp("www."),w=t.test(n);if(w)var n=n.replace("www.","");var a=CryptoJS.SHA256(n),c=e.toString(CryptoJS.enc.Hex),d=a.toString(CryptoJS.enc.Hex);c!==d&&document.write("<!--")}window.onload=function(){ul("3dfdb8b3b848048d9e30daa239fe1ef1a8ba33f6247200e2ec28ddfc12f3f94b")};
*/;(function($){
...
return this.each(function(){
 ...
 q2='12qwertzuiop\u00fc+asdfghjkl\u00f6\u00e4#<yxcvbnm,.-!"Ã‚Â§$%&/(()=?1234567890\u00df*p+',t=function(_1,_2){
